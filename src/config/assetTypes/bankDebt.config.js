...
export const BANK_DEBT_CONFIG = {
  id: 5, // ID del catalogo investmentTypes
  label: 'Bank Debt',
  color: '#00897B', // Teal
  ...
  flowConfig: {
    ...
    steps: [
      ...
      { id: 5, requiredFields: ['bankDebtTypeCode'] },
    ],
  },
  ...
  stepMessages: {
    ...
    5: 'Paso 5: Seleccione el tipo de deuda bancaria.',
  ...
  sections: {
    identifiers: {
      ...
      alerts: [
        {
          severity: 'info',
          message: 'Bank Debt no requiere Public_Data_Source.',
        },
      ],
    },
    ...
    parameters: {
      id: 'parameters',
      title: 'Parametros de Deuda Bancaria',
      icon: 'AccountBalanceIcon',
      step: 5,

      fields: {
        bankDebtTypeCode: {
          name: 'bankDebtTypeCode',
          label: 'Bank_Debt_Type_Code',
          type: 'select',
          required: true,
          optionsKey: 'bankDebtTypes',
          helpText: 'Tipo de deuda bancaria',
        },
      },
  ...
  validations: {
    bankDebtTypeRequired: {
      condition: (formData) => !formData.bankDebtTypeCode,
      field: 'bankDebtTypeCode',
      message: 'El tipo de deuda bancaria es obligatorio',
    },
  },
...
export default BANK_DEBT_CONFIG;