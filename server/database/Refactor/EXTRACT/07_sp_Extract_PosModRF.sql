...
Optimizaciones v4:
  - Temp table #PosModRF_Stage para estadisticas exactas
...
BEGIN
    ...
    -- Log inicio
    PRINT '========================================';
    PRINT 'EXTRACT_POSMODRF - INICIO (v4 - TempTable Stats)';
    ...
    BEGIN TRY
        ...
        -- =====================================================================
        -- FASE 1: Cargar datos en temp table (SQL Server crea estadisticas)
        -- =====================================================================
        DROP TABLE IF EXISTS #PosModRF_Stage;
        ...
        -- =====================================================================
        -- FASE 2: INSERT desde temp table (cardinalidad exacta conocida)
        -- =====================================================================
        BEGIN TRANSACTION;
