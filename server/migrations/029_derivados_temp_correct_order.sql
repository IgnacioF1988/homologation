-- =============================================
-- Migration 029: Derivados_Batch con temp table y orden correcto
-- Usa tabla temporal con el orden físico correcto de las columnas
-- =============================================
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Crear temp con orden que coincide con extract.Derivados
        ...
        -- Insertar en tabla final con validación IPA
...
PRINT '✅ Migration 029 completada - Extract_Derivados_Batch con temp table y orden correcto';
