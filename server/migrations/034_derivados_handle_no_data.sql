-- =============================================
-- Migration 034: Derivados_Batch - Manejar caso sin datos
-- Verifica si hay datos antes de procesar para evitar error de collation
-- =============================================
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Verificar si hay datos ANTES de hacer los JOINs complejos
        ...
        IF @SourceRows = 0
        BEGIN
            PRINT 'INFORMACION: No hay datos de Derivados para ' + @FechaReporte;
            PRINT 'COMPLETADO: Insertados=0, Tiempo=0s';
            RETURN 0;
        END
        ...
        -- Paso 4: Insertar en tabla final con validación IPA
...
PRINT '✅ Migration 034 completada - Extract_Derivados_Batch con validación temprana de datos';
GO
