-- =============================================
-- Migration 024: Recreate batch SPs (DROP + CREATE)
-- Elimina y recrea los SPs para evitar cache de metadata
-- =============================================

-- DROP existing batch SPs
IF OBJECT_ID('extract.Extract_PosModRF_Batch', 'P') IS NOT NULL
    DROP PROCEDURE [extract].[Extract_PosModRF_Batch];
GO

IF OBJECT_ID('extract.Extract_SONA_Batch', 'P') IS NOT NULL
    DROP PROCEDURE [extract].[Extract_SONA_Batch];
GO

IF OBJECT_ID('extract.Extract_CAPM_Batch', 'P') IS NOT NULL
    DROP PROCEDURE [extract].[Extract_CAPM_Batch];
GO
...
-- =============================================
CREATE PROCEDURE [extract].[Extract_PosModRF_Batch]
    @ID_Proceso BIGINT,
...
-- Extract_SONA_Batch
-- =============================================
CREATE PROCEDURE [extract].[Extract_SONA_Batch]
    @ID_Proceso BIGINT,
    @FechaReporte NVARCHAR(10)
AS
BEGIN
...
-- Extract_CAPM_Batch
-- =============================================
CREATE PROCEDURE [extract].[Extract_CAPM_Batch]
    @ID_Proceso BIGINT,
    @FechaReporte NVARCHAR(10)
AS
BEGIN
...
PRINT '✅ Migration 024 completada - SPs batch recreados correctamente';
