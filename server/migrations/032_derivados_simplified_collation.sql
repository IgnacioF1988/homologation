-- =============================================
-- Migration 032: Derivados_Batch con collation simplificada
-- Elimina comparaciones de strings literales que causan conflictos
-- =============================================
...
PRINT '✅ Migration 032 completada - Extract_Derivados_Batch con collation simplificada';
GO
