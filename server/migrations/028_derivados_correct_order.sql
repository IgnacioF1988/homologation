-- =============================================
-- Migration 028: Derivados_Batch con orden correcto de columnas
-- Las columnas del INSERT deben coincidir con el orden físico de la tabla
-- =============================================
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Usar CTE directamente sin tabla temporal
        ;WITH DerivadosData AS (
            SELECT
                d.FechaReporte,
...
PRINT '✅ Migration 028 completada - Extract_Derivados_Batch con orden físico correcto';
