-- =============================================
-- Migration 031: Derivados_Batch con USE DATABASE explícito
-- Asegura que estamos en la BD correcta
-- =============================================
...
PRINT '✅ Migration 031 completada - Extract_Derivados_Batch con USE DB explícito';
GO
